...
/**
 * Like {@link com.freiheit.sqlapi.domain.type.TransactionTemplate}, but for
...
public interface NonTransactionTemplate {
     ...
     * requested to execute this runnable - so if you implement
     * {@link Runnable#toString()} appropriately, you might be able to recover
